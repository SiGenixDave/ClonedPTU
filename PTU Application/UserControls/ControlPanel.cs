 ...
 */
/*
 *  02/21/2017  1.6.2   Vgott       References
 *                                  1. Enable the tooltip for buttons on ControlPanel.
 *                                      
 *                                  Modifications                                  
 *                                  1. Added tooltip text from Resource.resx file for all buttons on ControlPanel's Constructor.
 *                                 
 *                                      
 *
 */
/*
 *  06/24/2017  1.6.3   Vgott       References
 ...
 *                                      
 *                                  Modifications                                  
 *                                  1. Added the ControlPanel Load event. To display the PTU status panel header as "PTU STATUS" for BART and  "PTE STATUS" for other projects..
 *                                 
 *                                      
 *
 */
...
namespace Bombardier.PTU
{
    ...
    public partial class ControlPanel : UserControl
    {
        ...
        {
            InitializeComponent();
            this.m_ToolTip.SetToolTip(this.m_ButtonViewSystemInformation, Resources.HomeBtn_SystemInformation_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonDiagnosticsEventLog, Resources.HomeBtn_EventLog_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonDiagnosticsSelfTest, Resources.HomeBtn_SelfTest_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonViewWatchWindow, Resources.HomeBtn_Watch_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonDiagnosticsInitializeEventLogs, Resources.HomeBtn_ClearEventLog_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonPasswordProtection, Resources.HomeBtn_PwdManager_ToolTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonHelp, Resources.HomeBtn_Help_ToolTipPTU);
            this.m_ToolTip.SetToolTip(this.m_ButtonExit, Resources.HomeBtn_Exit_ToolTip);
        ...
        private void m_ButtonExit_Click(object sender, EventArgs e)
        {
           ...
           /* if (m_ToolStripMenuItemFileExit.Visible == false && m_ButtonViewSystemInformation.Enabled==true)
            {
        ...
        /// <summary>
        /// Event handler for the ControlPanel Load event. It display the PTU status panel header as "PTU STATUS" for BART and  "PTE STATUS" for other projects.
        /// </summary>
        /// <param name="sender">Reference to the object that raised the event.</param>
        /// <param name="e">Parameter passed from the object that raised the event.</param>
        private void ControlPanel_Load(object sender, EventArgs e)
        {
            switch (Parameter.isDisplayPTE)
            {
                case true:              
                    ...
                    break;
                default:
                    this.m_LegendPTUStatus.Text = Resources.PTU_Status;
                    this.m_ToolTip.SetToolTip(this.m_ButtonHelp, Resources.HomeBtn_Help_ToolTipPTU);
                    break;
            }
        }
