 ...
 *	
 *  08/05/13    1.4     K.McD           1.  Bug fix associated with an ArgumentException being thrown soon after the user had selected the default font. Removed the call
 *                                          to dispose of the m_Font member variable from the m_BtnDefaultFont_Click() method.
 *                                          
 *                                      2.  Added support for operating system specific default fonts to the m_BtnDefaultFont_Click() method.
 *                                      
 *  08/06/13    1.5     K.McD           1.  Created the static GetOSFont() method to get the current font or the default font, depending upon the state of the
 ...
 *                                          system.
 *                                      3.  Modified the constructor to use the GetOSFont() method to retrieve the current font rather than retrieving it directly from
 *                                          the Font setting.
 *                                      4.  Modified the m_BtnDefaultFont_Click() method to use the GetOSFont() method to retrieve the default font.
 *                                      5.  Modified the m_BtnOK_Click() method to use the SetOSFont() method to set the appropriate font setting rather than writing it
 *                                          directly to the Font setting.
 *                                      6.  Added the MajorBuildXP and MajorBuildWin7 constants to define the values of the Major component of the version number for the
 *                                          Window XP and Window 7 operating systems
 */
#endregion - [1.0 to 1.5] -

#region - [1.6 to 1.7] -
/*
 * 04/21/16     1.6     K.McD           References
 *                                      1.  Bug Fix - SNCR-PTU [01 Mar 2016] - Item 20. If the user tries to change the font to Microsoft JengHei, an ArgumentException
 *                                          is thrown with the error message ‘Only TrueType fonts are supported. This is not a TrueType font’.
 * 
 *                                      Modifications
 *                                      1.  Added a try/catch block to the m_BtnSelectFont_Click() method to set the font to the current font if an ArgumentException
 *                                          is thrown as a result of the m_FontDialog.ShowDialog() call.
 */
/*
 * 02/21/2017   1.7     vgottam         References
 *                                      1. Enable the tooltip for buttons on FormOptions.
 *                                      
 *                                      Modifications                              
 *                                      1. Added tooltip text from Resource.resx file for all buttons on FormOptions's Constructor.
 *                                 
 *                                      
 *
 */
#endregion - [1.6 to 1.7] -
...
namespace Bombardier.PTU.Forms
{
    ...
    public partial class FormOptions : FormPTUDialog
    {
        ...
        public FormOptions()
        {
            ...
            this.m_ToolTip.SetToolTip(this.m_ButtonCancel, Resources.OptionsWindow_BtnCancel_TooTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonOK, Resources.OptionsWindow_BtnOK_TooTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonDefaultApplications, Resources.OptionsWindow_BtnDefaultApp_TooTip);
            this.m_ToolTip.SetToolTip(this.m_ButtonDefaultFont, Resources.OptionsWindow_BtnDefaultFont_TooTip);
        }
        ...
        private void m_BtnSelectFont_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show(Resources.MBTNotTrueTypeFont, Resources.MBCaptionWarning, MessageBoxButtons.OK, MessageBoxIcon.Warning);

                // Set the Font back to the current Font.
                m_FontDialog.Font = GetOSFont(false);
            }
