 ...
 *	
 *	05/18/16	1.3	    D.Smail         References
 *	                                    1.  PTE Changes - List 5-17-2016.xlsx Item 3.   Login Screen - Add OK and Cancel buttons.
 *	
 *                                      Modifications
 *                                      1.  Extracted the LoginAttempt() method from the m_TxtPassword_KeyPress() method and called this directly from both the
 *                                          m_BtnOK_Click() and  m_TxtPassword_KeyPress() methods.
 *                                          
 *  08/03/2016  1.4     K.McD           References
