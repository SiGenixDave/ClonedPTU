 ...
 * 
 *  File name:  FormRealTimeClock.cs
 * 
 *  Revision History
 *  ----------------
 * 
 ...
 *                                          by the Use4DigitYearCode flag corresponding to bit 0 of the FunctionFlags bitmask field. This field is a bitmask that
 *                                          specifies which of the programmable function options are to be enabled for the current project. So far, the following flags
 *                                          have been defined:
 *
 ...
 *                                          Ref.: 1.1, 2.
 *
 *  07/202016   1.9    K.McD           References
 ...
 *  
 *                                      Modifications.
 *                                      1.  Renamed to FormRealTimeClock.
 *                                      
 *  02/21/2018  1.10   Vgottam          References
 *                                      1. Removed the Apply functionality as it does the same as OK functionality.
 *                                      2. Updated timer stop and start for the Manual and sync with PC options at button 'OK' click.
 *                                      
 */
...
namespace Bombardier.PTU.Forms
{
    ...
    /// </summary>
    public partial class FormRealTimeClock : FormPTUDialog, ICommunicationInterface<ICommunicationApplication>
    {
        #region --- Constants ---
        /// <summary>
