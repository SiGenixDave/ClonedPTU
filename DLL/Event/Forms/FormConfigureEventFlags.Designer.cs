 ...
 *  
 *  08/01/2016  1.2     K.McD           References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 45. On the 'Event History' dialog box, replace the 'Cumulative History' and 'Recent
 *                                          History' columns with a single 'Event History' column that gives the combined value of both cumulative and recent values.
 *                                      
 *                                      Modifications
 *                                      1.  Increased the ColumnHeadersHeight property of the m_DataGridViewEventStatus DataGridView from 36 to 40 px.
 *                                      2.  Changed the HeaderText property of the m_DataGridViewTextColumnRecentHistory DataGridViewTextBoxColumn to 'Event History'.
 *
 */
...
namespace Event.Forms
{
    partial class FormConfigureEventFlags
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.m_DataGridViewEventStatus.ColumnHeadersHeight = 40;
            ...
            // 
            this.m_DataGridViewTextColumnEnableEvent.HeaderText = "Event Trigger";
            ...
            // 
            this.m_DataGridViewTextColumnStreamTriggered.HeaderText = "Stream Trigger";
            ...
            // 
            this.m_DataGridViewTextColumnRecentHistory.HeaderText = "Event History";
