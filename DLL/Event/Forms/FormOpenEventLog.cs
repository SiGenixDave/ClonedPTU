...
#region - [1.16] -
/*
 *  03/15/16    1.16    K.McD       References
 ...
 *                                          human readable format in additional columns within the CSV file. Event counters shall be stored in a separate CSV file. The
 *                                          columns of the CSV file shall follow the event log file format definition in 071-ICD-0004 [2], Section 3.1, Table 12
 *                                          (Counters) and Table 13 (Event Records).
 *                                          
 *                                  Modifications
 *                                  1.  Added the call to FileHandling.Serialize<EventLogFile_t>() in the SaveEventLogFile() method and F3_Click() methods to generate
 *                                      the CSV file corresponding to the event log.
 *                                  
 */

/*
 *  04/14/2016  1.16.1  K.McD       References
 ...
 *                                  
 *                                  Modifications
 *                                  1.  Modified the SaveEventLogFile() method to create the CSV file if the GenerateCSV property of the Parameter static class is
 *                                      asserted.
 *                                  2.  Modified the F3_Click() method to create the CSV file if the GenerateCSV property of the Parameter static class is
 *                                      asserted.
 */
#endregion - [1.16] -
...
#region - [1.17] -
/*
 * 06/23/2017  1.17.0       Vgott   References
    ...
    public partial class FormOpenEventLog : FormViewEventLog, IEventLogFile
    {
        ...
        public void SaveEventLogFile()
        {
            ...
            if (Parameter.GenerateCSV == true)
            {
                ...
                FileHandling.Serialize<EventLogFile_t>(EventLogFile.FullFilename.Replace(CommonConstants.ExtensionEventLog, CommonConstants.ExtensionCSV),
