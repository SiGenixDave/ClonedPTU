 ...
 *                                          
 *  
 *  06/23/2017  1.12    Vgott           1.  Added truck type parameter as as empty to DeriveName() method in F3_Click event.
 *  
 * 
 *  09/12/2017  1.13    Vgott           1.  Disabled Menu items KeyMenuItemDiagnostics and KeyMenuItemViewWatchWindow. 
 */
...
namespace Event.Forms
{
    ...
    public partial class FormViewFaultLog : FormDataStreamPlot
    {
        ...
        protected override void F3_Click(object sender, EventArgs e)
        {
            ...
            string defaultFilename = General.DeriveName(FileHeader.HeaderCurrent.TargetConfiguration.CarIdentifier, tripTime, CommonConstants.ExtensionFaultLog, WatchFile.DataStream.EventDescription,string.Empty);
