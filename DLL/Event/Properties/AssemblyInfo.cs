...
#region - [1.26] -
/*
 *  02/03/2016  1.26    DAS            References
 ...
 *                                      
 *                                      Modifications
 *                                      1.  \Communication\CommunicationEventOffline.cs Rev. 1.4. - Ref.: 1.
 *                                      2.  \Communication\CommunicationEvent.cs Rev 1.12. - Ref.: 1.
 *                                      3.  \Forms\FormViewEventLog.cs Rev. 2.4. - Ref.: 2.
 *                                      4.  ThreadPollEvent.cs Rev. 1.7. - Ref.: 2.
 *                                      5.  Removed \Communication\VcuCommunication32Event.cs, \Communication\VcuCommunication64Event.cs. - Ref.: 1.
 */
#endregion - [1.26] -

#region - [1.27] -
/*
 *  03/15/16    1.27    K.McD       References
 ...
 *                                          
 *                                  Modifications
 *                                  1.  Modified FormViewEventLog.cs. Rev. 2.5.
 *                                  2.  Modified FormOpenEventLog.cs. Rev. 1.16.                               
 */

/*
 *  04/14/2016  1.27.1  K.McD       References
 ...
 *                                  
 *                                  Modifications
 *                                  1.  FormViewEventLog.cs. Rev. 2.5.1. - Ref.: 1.
 *                                  2.  FormOpenEventLog.cs. Rev. 1.16.1. - Ref.: 1.
 */

/*
 *  07/11/2016  1.27.2  K.McD       References
 *                                  1.  PTE Changes - List 5-17-2016.xlsx Item 14. DataStream Configuration - Change the word 'Download'
 *                                      to 'Upload'.
 *                                      
 ...
 *                                      
 *                                  3.  PTE Changes - List 5-17-2016.xlsx Item 43 and 65. Home / Event Log Screens - After selecting the 'F5-Init' ToolStripButton on
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Resources.resx. Modified the string resource MBTConfirmClearEventLogs to prepend original string with the text 'Initializing
 *                                      event logs will reset all flags to default, clear all cumulative history, and erase all event logs.'. - Ref.: 3.
 *                                  2.  FormWorksetDefineFaultLog.cs. Rev. 1.10. - Ref.: 2.
 *                                  3.  FormWorksetDefineFaultLog.Designer..cs. Rev. 1.8. - Ref.: 2.
 *                                  4.  FormConfigureFaultLogParameters.cs. Rev. 2.5. - Ref.: 2.
 *                                  5.  FormConfigureFaultLogParameters.Designer.cs. Rev. 1.5. - Ref.: 2.
 */

/*
 *  07/21/2016  1.27.3  K.McD       References
 *                                  1.  Bug Fix - SNCR - PTU [01 Mar 2016] - Item 21. When displaying enumerator variables the display should toggle between the raw
 ...
 *                                  3.  PTE Changes - List 5-17-2016.xlsx Item 64. When double-clicking on the '(Bit Mask)' component of the Watch Variable
 ...
 *    
 *                                  Modifications
 *                                  1.  FormViewEventLog.cs. Rev. 2.5.2. - Ref.: 1, 2, 3, 4.
 */

/*                                  
 *  08/01/2016  1.27.4  K.McD       References
 ...
 *                                      dialog boxes, change the word 'Workset' to 'Chart Recorder Configuration', 'Data Stream Configuration' and
 *                                      'Watch Window Configuration' respectively and change the title of each dialogbox to be 'Configure - Chart Recorder',
 *                                      'Configure - Data Stream' and 'Configure - Watch Window'.
 *    
 *                                  Modifications
 *                                  1.  FormGetFltHistInfo.Designer.cs. Rev. 1.1. - Ref.: 1. FormGetFltHistInfo.cs. Rev. 1.2. - Ref.: 1.
 *                                  2.  FormWorksetDefineFaultLog.Designer.cs. Rev. 1.9. - Ref.: 2, 4.
 *                                  3.  Resources.resx. - Ref. 2, 4.
 *                                      1.  TitleEditFaultLogWorksets changed to 'Configure - Data Streams'.
 *                                      2.  TitleRenameFaultLogWorkset changed to 'Rename - Data Stream Configuration'.
 *                                      3.  TitleCopyFaultLogWorkset changed to 'Copy - Data Stream Configuration'.
 *                                      4.  TitleCreateFaultLogWorkset changed to 'Create New - Data Stream Configuration'.
 *                                      5.  TitleConfigureFaultLogParameters changed to 'Configure - Data Streams'.
 *                                      6.  Added FunctionKeyToolTips for the Upload, Save, Create New, Configure, Copy and Rename ToolStripButtons.
 *
 *                                  4.  FormConfigureEventFlags.cs. Rev. 1.4. - Ref.: 3.
 *                                  5.  FormConfigureEventFlags.Designer.cs. Rev. 1.2. - Ref.: 3.
 *                                  6.  FormShowEventHistory.cs. Rev. 1.4. - Ref.: 3.
 *                                  7.  FormConfigureFaultLogParameters.Designer.cs. Rev. 1.6. - Ref.: 4.
 *                                  8.  FormConfigureFaultLogParameters.cs. Rev. 2.6. - Ref.: 4.
 *                                  9.  FormWorksetManagerFaultLog.Designer.cs. Rev. 1.4. - Ref.: 4.
 */

/*
 *  09/06/2016  1.27.5  K.McD       References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  FormConfigureFaultLogParamters.cs. Rev. 2.7. - Ref.: 1.
 *                                  2.  FormViewEventLog.cs. Rev.: 2.5.3. - Ref.: 2.
 *                                  3.  MenuInterfaceEvent.cs. Rev. 1.8. - Ref.: 2.
 *                                  4.  Resources.resx. Added a number of ToolTip strings.
 */

/*
 *  09/13/2016  1.27.6  K.McD       References
 *                                  1.  Bug Fix - Support 4 digit year code returned from VCU.
 * 
 *                                  Modifications
 *                                  1.  CommunicationEvent.cs. Rev. 1.13. - Ref.: 1.  
 */

/*
 *  02/07/2017  1.27.7  Vgott       References
 *                                  1. Add the text “PC” to “Date” in the Event Window.
 *                                  2. Change the word “Set” to “Enabled” and “Reset” to “Disabled” in "Configuration Event Flags" dialog box from Event Log Window.
 * 
 *                                  Modifications
 *                                  1. Updated the text associated with InformationLegendDate in Resources.resx file.
 *                                  2. Updated the text associated with TextReset and TextSet in Resources.resx file.
 */
/*
 *  02/07/2017  1.27.8  Vgott       References
 ...
 */
/*
 *  02/21/2017  1.27.9  Vgott       References
...
#region - [1.28] -
/*
 *  XX/XX/2017     1.28.1   D.Smail  Modifications
 ...
 *                                      the VCU. 
 *                                  2.  When navigating back to the Home screen, all buttons will now be disabled on the Home 
 ...
 *                                  3.  When communication is lost to the target hardware, disable all controls
 ...
 *                                      the Watch Variables.
 *                                  4. When communication is lost when trying to save event logs, the code now
 ...
 *                                  5.  When communication is lost to the target hardware, inform the Main Window of 
 *                                      this event by making the Main Window's Communication Interface = null.
 *                                  6.  Upon exiting the Event Form, inform the Main Window to resume polling the 
 *                                      target hardware.

 * 
 */
/*
 *  06/23/2017     1.28.2   Vgott   References
 *                                  1.  Update the tooltip text for F6-Flags and F8-Stream buttons.
 ...
 *                                  
 *                                  Modifications
 *                                  1.  Update the tooltip text as "Open Data Stream Configuration window" instead "Configure Data Stream" for F6-Flags.
 *                                  2.  Update the tooltip text as "Open Event Flags Configuration window" instead "Configure Event Flags" for F8-Stream.
 *                                  3.  Added truck type parameter as as empty to DeriveName() method if the default file structure is other than EventLogs.
 * 
 */
/*
 *  09/12/2017     1.28.3   Vgott   Modifications
 *                                  1.  Disabled Menus of main window,Menu: Diagnostics and pull down menu item: View->WatchWindow.
 *                                                                                              
 */
/*  
 *  06/21/2018     1.28.4   R.Schwartz  
 *                                  Modifications:
