...
/*
 *  05/20/2016  1.9     DAS             References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Items 40, 50, 52, 55. All Child Forms - Remove "F1-Help".
 *                                      2.  PTE Changes - List 5-17-2016.xlsx Items 41, 51, 53, 57. All Child Forms - Change "F2-Print" to "F2-PrtScn".
 *                                      3.  PTE Changes - List 5-17-2016.xlsx Items 39, 54.         All Child Forms - Change "Esc" to "Home" on all child forms.
 *                              
 *                                      Modifications
 *                                      1.  Removed m_TSBF1 ToolStripButton and m_TSSeparatorF1 ToolStripSeparator. - Ref.: 1.
 *                                      2.  Changed the Tag and Text properties of the mTSBEsc ToolStripButton to "Home". - Ref.: 3.
 *                                      3.  Changed the Text property of the m_TSBF2 ToolStripButton to "PrtScn". - Ref.: 2.
 *                                      4.  Modified the ToolTipText property of the m_TSBF2 ToolStripButton. - Ref.: 2.
 */

/*
 *  08/03/2016  1.10    K.McD   References
 ...
 *                              
 *                              Modifications
 *                              1.  Set the Image property of the m_TSBF1 ToolStripButton to be 'Resources.EnumeratorsAsNumbers'.   
 */
/*
 *  02/21/2017  1.11    Vgott   References
 *                              1. Update the tooltip text as suggested in "Tooltip Analysis on PTU App-ANC_02162017.docx".
 *                                   
 *                              Modifications
 *                              1. Update the tooltip text for common buttons Esc,F1,F2.
 *                                      
 * 
 */
...
namespace Common.Forms
{
    partial class FormPTU
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.m_TSBEsc.Tag = "Home";
            this.m_TSBEsc.Text = "Home";
            ...
            this.m_TSBEsc.ToolTipText = "Close window & return to Home Window - [ ESC ]";
            ...
            this.m_TSBF1.Image = global::Common.Properties.Resources.EnumeratorsAsNumbers;
            ...
            this.m_TSBF1.RightToLeftAutoMirrorImage = true;
            this.m_TSBF1.Size = new System.Drawing.Size(70, 50);
            this.m_TSBF1.Tag = "F1";
            this.m_TSBF1.Text = "F1-Enum.";
            ...
            this.m_TSBF1.ToolTipText = "Show enumerators as integer values – [ F1 ]";
            ...
            this.m_TSBF2.Image = global::Common.Properties.Resources.ScreenShot ;
            ...
            this.m_TSBF2.ToolTipText = "Screen capture of data in current window – [ F2 ]";
            ...
            this.m_ToolStripComboBox1.Size = new System.Drawing.Size(250, 23);
