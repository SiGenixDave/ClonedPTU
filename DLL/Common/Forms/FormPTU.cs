 ...
 *                                  
 *                                  Modifications
 *                                  1.  Added CommonConstants.ProjectIdR179 to the switch statement in the F1_click() event handler.
 */

/*
 *  05/20/2016  1.20    DAS     References
 *                              1.  PTE Changes - List 5-17-2016.xlsx Items 40, 50, 52, 55. All Child Forms - Remove "F1-Help".
 *                              
 *                              Modifications
 *                              1.  Removed all references to the m_TSBF1 ToolStripButton.
 */

/*
 *  07/25/2016 1.21     K.McD   References
 *                              1.  PTE Changes - List 5-17-2016.xlsx Item 64. When double-clicking on the '(Bit Mask)' component of the Watch Variable
 ...
 *                                  
 *                              2.  PTE Changes - List 5-17-2016.xlsx Item 10, 49, 58. The 'Configure/Enumeration' drop-down menu option is to be replaced by
 *                                  individual ToolStripButton controls on the 'Watch Window', 'Event Log' and 'Self Test' screens.
 *                              
 *                              Modifications
 *                              1.  Modified the FormPTU_Resize() event handler to call the CloseShowFlags() method. This will close any FormShowFlags forms that
 *                                  are open whenever the user minimizes, or resizes the form. - Ref.: 1.
 *                                  
 *                              2.  Added the ShowEnumeratorAsIntegers control flag property and associated member variable. When the ShowEnumeratorAsIntegers
 *                                  control flag is asserted enumerators aree displayed as integer values; otherwise, enumerators are displayed as their corresponding
 *                                  text strings.
 *                              
 *                              3.  Restored the F1 ToolStripButton. This is now used to toggle the state of the ShowEnumeratorAsIntegers property. - Ref.: 2.
 */

/*
 *  08/03/2016  1.22    K.McD   References
 *                              1.  PTE Changes - List 5-17-2016.xlsx Item 10, 49, 58. The 'Configure/Enumeration' drop-down menu option is to be replaced by
 *                                  individual ToolStripButton controls on the 'Watch Window', 'Event Log' and 'Self Test' screens.
 *                              
 *                              Modifications
 *                              1.  Now passes the 'Resources.EnumeratorsAsNumbers' image in the call to the DisplayFunctionKey() method associated with the F1 key
 *                                  in the constructor.
 *                              2.  Modified the F1_Click() event handler to toggle between the 'Resources.EnumeratorsAsNumbers' and 'Resources.EnumeratorsAsText'
 *                                  images when the user presses the F1 ToolStripButton.
 */
/*
 *  02/21/2017  1.23    Vgott   References
 *                              1. Update the tooltip text format by adding '[' and ']' characters to functionkeys only and keys are at the end of the text.
 *                                      
 *                              Modifications
 *                              1. Update the tooltip text format and chages done in the DisplayFunctionKey() for suggested tooltip format.
 *                                     
 * 
 */
/*
 *  06/23/2017  1.24    Vgott   References
 ...
 *                                  
 *                                  Modifications
 *                                  1.  Added truck type parameter as as empty to DeriveName() method in F2_Click event.
 *                                     
 * 
 */
...
namespace Common.Forms
{
    ...
    public partial class FormPTU : Form
    {
        ...
        /// </summary>
        protected bool m_ShowEnumeratorAsIntegers = false;
        ...
        public FormPTU()
        {
            ...
            F1.Checked = ShowEnumeratorAsInteger;
            DisplayFunctionKey(F1, Resources.FunctionKeyTextEnumerator, Resources.FunctionKeyToolTipEnumAsValues, Resources.EnumeratorsAsNumbers);
        ...
        /// <param name="sender">Reference to the object that raised the event.</param>
        /// <param name="e">Parameter passed from the object that raised the event.</param>
        protected virtual void F1_Click(object sender, EventArgs e)
        {
            // Skip, if the Dispose() method has been called.
            if (IsDisposed)
            {
            ...
            // Toggle the state of the ShowEnumeratorAsText property.
            ShowEnumeratorAsInteger = !ShowEnumeratorAsInteger;
            if (ShowEnumeratorAsInteger == true)
            {
                DisplayFunctionKey(F1, Resources.FunctionKeyTextEnumerator, Resources.FunctionKeyToolTipEnumAsStrings, Resources.EnumeratorsAsText);
            }
            else
            {
                DisplayFunctionKey(F1, Resources.FunctionKeyTextEnumerator, Resources.FunctionKeyToolTipEnumAsValues, Resources.EnumeratorsAsNumbers);
        ...
        protected void DisplayFunctionKey(ToolStripButton functionKey, string text, string toolTip, Image image)
        {
            ...
            {
                functionKey.ToolTipText = String.Format("{0} - [ {1} ]", toolTip , functionKey.Tag as string) ;
            }
            else
            {
        ...
        #region -[ShowEnumeratorAsInteger] -
        /// <summary>
        ...
        /// </summary>
        public bool ShowEnumeratorAsInteger
        {
            get { return m_ShowEnumeratorAsIntegers; }
            set { m_ShowEnumeratorAsIntegers = value; }
        }
        #endregion -[ShowEnumeratorAsInteger] -
