 ...
 *                                  
 *  06/05/2017  1.6    D.Smail      Modifications
 *                                  1.  Per Atul Chaudhari request, change/override the "Cancel" button text to "Close" for all "Configure" forms.
 *                                      Having the text "Cancel" implies that the none of the user changes would have been saved 
 */
