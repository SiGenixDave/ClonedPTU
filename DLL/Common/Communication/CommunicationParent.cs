 ...
 * 
 *                                      Modifications
 *                                      1.  Removed all delegates to unmanaged code as well as any references as to whether the operating system is 32 or 64 bits. 
 *                                          All legacy C++ code used to interface to the embedded target has been converted to C# and thus
 *                                          only 1 PTU application is now needed.
 *                                     
 *                                      2.  Added the ICommDevice and WatchClockMarshal properties and associated member variables so that communication to the
 *                                          embedded target can take place. These objects are used in place of the previous delegates.
 */
#endregion- [3.0] -

#region - [3.1] -
/*
 *  03/15/16    3.1     K.McD           References
 ...
 *                                              
 *                                      Modifications
 *                                      1.  Modified the TargetConfiguration_t structure to use get and set accessors to access the private member variables.
 */
#endregion - [3.1] -

#region - [3.2] -
/*
 *  04/02/16    3.2     K.McD           References
 ...
 *                                              
 *                                      Modifications
 *                                      1.  Reverted the TargetConfiguration_t structure back to the one used in Rev. 3.0.
 */
#endregion - [3.2] -

#region - [3.3] -
/*
 *  06/15/2016  3.3     D.S             References
 *                                      1.  
 *                                      
 *                                      Modifications.
 *                                      1. Changed the value of the constant DefaultMutexWaitDurationMs from 2,000 to 20,000.  
 */
#endregion - [3.3] -
#region - [3.4] -
/*
 *  11/06/2017  3.4     vgottam         References
 *                                      1.  CTA 5000 - PTU issue with delay time. 
 *                                      
 *                                      Modifications.
 *                                      1. Changed the value of the constant DefaultMutexWaitDurationMs from 20,000 to 120,000.  
 */
#endregion - [3.4] -
#endregion --- Revision History ---
...
namespace Common.Communication
{
    ...
    public class CommunicationParent : ICommunicationParent
    {
        ...
        /// <summary>
        /// The default number of ms to wait before releasing the communication mutex. Value: 120,000.
        /// </summary>
        protected const int DefaultMutexWaitDurationMs = 120000;
