 ...
 *                                              
 *  01/20/2015  1.14    DAS             References
 ...
 *                                          
 *                                      Modifications
 *                                      1.  Removed the SetWatchSize(m_WatchSize) call in the Initialize() static method.
 *                                          Unmanaged code required knowledge of the watch size in order to allocate memory. 
 *                                          Managed code no longer needs this knowledge because arrays that are passed to 
 *                                          objects inherently have size (Length) associated with them. Unmanaged code could 
 *                                          not access these attributes.
 */

/*
 *  04/14/2016  1.14.1  K.McD       References
 ...
 *                                  
 *                                  Modifications
 *                                  1.  Added the GenerateCSV static property and the associated static member variable.
...
namespace Common.Configuration
{
    ...
    public static class Parameter
    {
        ...
        /// false.
        /// </summary>
        private static bool m_GenerateCSV = false;
        ...
        /// otherwise, false.
        /// </summary>
        public static bool GenerateCSV
        {
            get { return m_GenerateCSV; }
        }
