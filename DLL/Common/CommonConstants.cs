...
/*
 *  11/16/15    1.15    K.McD     References
 *                                  1.  Added support for R179.
 *                                  
 *                                  Modifications
 *                                  1.  Added the ProjectIdR179 constant.
 *                                  
 */
#endregion - [1.0 to 1.15] -

#region - [1.16] -
/*
 *  03/14/2016  1.16    D.S         References
 *                                  1.  Bug fix - SNCR - PTU [01 Mar 2016] - Item 13. When viewing the Event Screen, the Maintenance log always downloads and updates
 ...
 *                                      
 *                                  2.  PTU Modifications to Support the Requirements Defined in the San Francisco Bay Area Rapid Transport (BART) PTU Generic
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Modified the  TimeoutMsPauseFeedback from 1,000 ms to 3,000ms. - Ref.: 1.
 *                                  2.  Added the ProjectIdBART project identification string constant and the ExtensionCSV constant. 
 */
#endregion - [1.16] -
...
/*
 *  Date        Version     Author  Comments
 *  05/12/2016  1.17        K.McD   References
 ...
 * 
 *                                  Modifications
 *                                  1.  Added the BART Windows group names associated with SecurityLevel1 and SecurityLevel2 clearance.
 */

/*
 *  07/21/2016  1.17.1      K.McD   References
 ...
 *    
 *                                  Modifications
 *                                  1.  Renamed KeyToolStripSeparatorHelpPTUHelp to KeyToolStripSeparatorHelpShowUserManual and changed the value to
 *                                      "m_SeparatorHelpShowUserManual".
 *                                      
 *                                  2.  Renamed KeyMenuItemHelpPTUHelp to KeyMenuItemHelpShowUserManual and changed the value to "m_MenuItemHelpShowUserManual".
 *                                  
 *  08/02/2016  1.17.2      K.McD   References
 ...
 *                                  
 *                                  Modifications
 *                                  1.  Added the access keys to the ToolStripButton controls associated with FormConfigure.cs.
 *                                  
 *  08/09/2016  1.17.3      K.McD   References
 ...
 *                                      
 *                                  Modifications
 *                                  1.  Added keys to access the 'Delete', 'Set As Default' and 'Override Security' ToolStripButton controls.
 * 
 *  02/11/2018  1.17.4      Vgott   Modifications
 *                                  1.  Added new project ID as PAQA for Pgh LRV.
 *                                  
 *  05/19/2018  1.17.5      Vgott   Modifications
 *                                  1.  Added new file extesion for Word document.
 *                                  
 *  02/11/2018  1.17.4      Vgott   Modifications
 *                                  1.  Added new project ID as MAPA for MARTA.
 *  12/06/2018  1.17.5      Vgott   Modifications
 *                                  1.  Added new project ID as 300R for INNOVIA APM300.                                  
 *                                  
 * 
 */
#endregion - [1.17] -
...
namespace Common
{
    ...
    public class CommonConstants
    {
        ...
        /// </summary>
        public const string ProjectIdBART = "BART";

        /// <summary>
        /// The project identifier associate with the R179 Propulsion Car Control Unit project. Value: "MTPE".
        /// </summary>
        public const string ProjectIdR179 = "MTPE";

        /// <summary>
        /// The project identifier associated with the Toronto Rocket project. Value: "TOPC".
        /// </summary>
        public const string ProjectIdRocket = "TOPC";

        /// <summary>
        /// The project identifier associate with the Pgh LRV Propulsion Car Control Unit project. Value: "PAQA".
        /// </summary>
        public const string ProjectIdPAQA = "PAQA";
        /// <summary>
        /// The project identifier associate with the MARTA Propulsion Car Control Unit project. Value: "MAPA".
        /// </summary>
        public const string ProjectIdMAPA = "MAPA";
        /// <summary>
        /// The project identifier associate with the INNOVIA APM 300/300R Propulsion Car Control Unit project. Value: "MAPA".
        /// </summary>
        public const string ProjectIdAPM = "300R";
        #endregion - [Project Identifiers] -

        #region - [Windows Group Names] -
        /// <summary>
        /// The BART Windows group name associated with SecurityLevel1 clearance. Value: "PrimaryMaintenance".
        /// </summary>
        public const string UserGroupBARTLevel1 = "PrimaryMaintenance";

        /// <summary>
        /// The BART Windows group name associated with SecurityLevel2 clearance. Value: "Engineering".
        /// </summary>
        public const string UserGroupBARTLevel2 = "Engineering";
        #endregion - [Windows Group Names] -
        ...
        /// </summary>
        public const string KeyToolStripSeparatorHelpShowUserManual = "m_SeparatorHelpShowUserManual";
        ...
        /// </summary>
        public const string KeyMenuItemConfigureDataStream = "m_MenuItemConfigureDataStream";

        /// <summary>
        /// Key to access the 'Configure/Watch Window' menu option. Value: "m_MenuItemConfigureWatchWindow".
        /// </summary>
        public const string KeyMenuItemConfigureWatchWindow = "m_MenuItemConfigureWatchWindow";
        ...
        /// </summary>
        public const string KeyMenuItemHelpShowUserManual = "m_MenuItemHelpShowUserManual";
        ...
        /// <summary>
        /// The file extension associated with the diagnostic alternative help file. Value ".chm".
        /// </summary>
        public const string ExtensionAltHelpFile = ".chm";
        ...
        /// <summary>
        /// The file extension associated with the Word document files. Value ".doc".
        /// </summary>
        public const string ExtensionDoc = ".doc";
        ...
        /// </summary>
        public const int TimeoutMsPauseFeedback = 3000;
