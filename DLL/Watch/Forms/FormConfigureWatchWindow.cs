 ...
 *  
 *	29/06/2017	1.1		Vgott			Modifications
 *	                                    1.  Updated tooltips info for toolstrip menu with Watch window info instead of Chart recorder info.
 *	                                    2.  Added Tooltip text to m_ButtonMoveUp and m_ButtonMoveDown
 */
...
namespace Watch.Forms
{
    ...
    public partial class FormConfigureWatchWindow : FormConfigure, ICommunicationInterface<ICommunicationWatch>
    {
            ...
            : base(worksetCollection)
        {
            ...
            #region - [ToolTipText] -
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonUpload].ToolTipText = Resources.FunctionKeyToolTipWatchWindowUpload;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonSave].ToolTipText = Resources.FunctionKeyToolTipWatchWindowSave;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonEdit].ToolTipText = Resources.FunctionKeyToolTipWatchWindowConfigure;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonNew].ToolTipText = Resources.FunctionKeyToolTipWatchWindowCreate;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonCopy].ToolTipText = Resources.FunctionKeyToolTipWatchWindowCopy;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonRename].ToolTipText = Resources.FunctionKeyToolTipWatchWindowRename;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonDelete].ToolTipText = Resources.FunctionKeyToolTipWatchWindowDelete;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonSetAsDefault].ToolTipText = Resources.FunctionKeyToolTipWatchWindowSetAsDefault;
            m_ToolStrip.Items[CommonConstants.KeyToolStripButtonOverrideSecurity].ToolTipText = Resources.FunctionKeyToolTipWatchWindowOverrideSecurity;
            this.m_ToolTip.SetToolTip(this.m_ButtonMoveUp, Resources.UpBtnTooltipText);
            this.m_ToolTip.SetToolTip(this.m_ButtonMoveDown, Resources.DownBtnTooltipText);
