 ...
 *                                      
 *                                      Modifications
 *                                      1.  \Communication\CommunicationWatch.cs Rev. 1.14. - Ref.: 1.
 */
#endregion - [1.28] -

#region - [1.29] -
/*                              
 *  05/18/2016  1.29     KMcD           References
 ...
 *                                          
 *                                      2.  PTE Changes - List 5-17-2016.xlsx Item 14. Chart Recorder/DataStream Configuration Screens - Change the word 'Download'
 *                                          to 'Upload'.
 *                                      
 *                                      Modifications
 *                                      1.  FormWorksetDefineWatch.cs. Rev. 1.7. - Ref.: 1. FormWorksetDefineWatch.Designer.cs. Reverted to Rev. 1.1. - Ref.: 1.
 *                                          Previous changes by Dave Smail were incorrect. The individual column count information was not shown for column 1 when
 *                                          viewing WatchWindow worksets.
 *                                      2.  FormWorksetDefineChartRecorder.cs. Rev. 1.7. - Ref.: 1. FormWorksetDefineChartRecorder.Designer.cs. Rev. 1.4. - Ref.: 1.
 *                                      3.  FormConfigureChartRecorder.cs. Rev. 1.13. - Ref.: 1, 2. FormConfigureChartRecorder.Designer.cs. Rev. 1.3. - Ref.: 1.
 */

/*
 *  07/21/2016  1.29.1  K.McD           References
 *                                      1.  PTE Changes - List 5-17-2016.xlsx Item 56. Remove the 'F4-Pause' ToolStripButton from the 'Watch Window' screen.
 *                                      2.  PTE Changes - List 5-17-2016.xlsx Item 67. In the 'Workset' drop-down menu on the right side of the 'View/Watch Window'
 *                                          screen, the order in which the worksets are arranged changes whenever a workset is selected or the application is
 *                                          opened/closed. This order should be permanently fixed.
 *                                      3.  PTE Changes - List 5-17-2016.xlsx Item 18. Use a double-click to change the chart scale factor on the
 *                                          'Chart Recorder Configuration' dialog box.
 *                                      
 *                                      Modifications
 *                                      1.  FormViewWatch.cs. Rev. 1.15.1. - Ref.: 1.
 *                                      2.  FormViewWatch.cs. Rev. 1.15.1. - Ref.: 2.
 *                                      3.  FormWorksetDefineChartRecorder.cs. Rev. 1.8. - Ref.: 3.
 *                                      4.  FormWorksetDefineChartRecorder.Designer.cs. Rev. 1.5. - Ref.: 3.
 *                                      5.  FormConfigureChartRecorder.cs. Rev. 1.14. - Ref.: 3.
 *                                      6.  FormConfigureChartRecorder.Designer.cs. Rev. 1.4. - Ref.: 3.                                  
 */

/*
 *  07/21/2016  1.29.2  K.McD           References
 ...
 *                                          
 *                                      2.  PTE Changes - List 5-17-2016.xlsx Items 16, 24, 61.  For the Chart Recorder, Data Stream and Watch Window configuration
 ...
 *                                          Streams' and 'Configure - Watch Windows'.
 *  
 *                                      Modifications
 *                                      1.  Resources.resx.
 *                                              1.  FunctionKeyTextEdit changed from 'Modify' to 'Config'.
 *                                              2.  FunctionKeyToolTipEdit changed from [Modify Current Workset] to [Configure Watch Window].
 *                                              3.  TitleEditChartRecorderWorkset changed to 'Configure - Chart Recorder'.
 *                                              4.  TitleCreateChartRecorderWorkset changed to 'Create New - Chart Recorder Configuration'.
 *                                              5.  TitleRenameChartRecorderWorkset changed to 'Rename - Chart Recorder Configuration'.
 *                                              6.  TitleCopyChartRecorderWorkset changed to 'Copy - Chart Recorder Configuration'.
 *                                              7.  Added LegendConfiguration and LegendWatchConfiguration.
 *                                              8.  Added FunctionKeyToolTips for the Upload, Save, Create New, Configure, Copy and Rename ToolStripButtons.
 *                                              
 *                                      2.  FormWorksetDefineChartRecorder.Designer.cs. Rev. 1.6. - Ref.: 1.
 *                                      3.  FormWorksetDefineWatch.Designer.cs. Rev. 1.2. - Ref.: 1.
 *                                      4.  FormConfigureChartRecorder.Designer.cs. Rev. 1.5. - Ref.: 2.
 *                                      5.  FormConfigureChartRecorder.cs. Rev. 1.15. - Ref.: 2.
 *                                      6.  FormWorksetManagerWatch.Designer.cs. Rev. 1.4. - Ref.: 2.
 *                                      7.  FormWorksetManagerChartRecorder.Designer.cs. Rev. 1.1. - Ref.: 2.
 *                                      8.  FormViewWatch.cs. Rev. 1.15.2. - Ref.: 2.
 *                                      9.  FormOpenWatch.cs. Rev. 1.5. - Ref.: 2.
 *                                      10. FormOpenSimulatedFaultLog.cs. Rev. 1.7. - Ref.: 2.                                               
 */

/*
 *  08/10/2016  1.29.3  K.McD           References
 ...
 *                                          
 *                                      4.  Bug Fix - The contents of the 'Notes' GroupBox control on ALL dialogboxes derived from the 'Workset Manager' form cannot be
 *                                          fully seen as the size of the dialogboxes is too small.
 *  
 *                                      Modifications
 *                                      1.  Resources.resx. - Ref.: 1, 2.
 *                                          1.  Added the 'MBTModifyChartRecorderModeFailed' string resource.
 *                                          2.  Added ToolTip string resources for the Delete, Set As Default and Override Security ToolStripButton controls.
 *                                          3.  Added Undo ToolTip string resources for the Edit, New, Copy, Rename, Delete, Set As Default and Override Security
 *                                              ToolStripButton controls.
 *                                          4.  Renamed ToolTip string resources for the Upload, Save, Edit, New, Copy and Rename ToolStripButton controls.
 *                                          5.  Added: 'Ramp Mode', 'Zero Output', 'Full Scale' and 'Data Mode' images.
 *                                      2.  FormConfigureChartRecorder.cs. Rev. 1.16. - Ref.: 1, 2, 3.
 *                                      3.  FormConfigureChartRecorder.Designer.cs. Rev. 1.6. - Ref.: 1, 2.
 *                                      4.  Added FormConfigureWatchWindow Form. Rev. 1.0. - Ref.: 2, 3.
 *                                      5.  FormWorksetManagerWatch.Designer.cs. Rev. 1.4. - Ref.: 4.
 *                                      6.  FormWorksetManagerChartRecorder.Designer.cs. Rev. 1.1. - Ref.: 4.
 * 
 */

/*
 *  02/07/2017  1.29.4  Vgott           References
 *                                      Add the text “PC” to “Date” in Data Monitor Window.
 *                                      
 *                                      Modifications
 *                                      Updated the text associated with InformationLegendDate in Resources.resx file.   
 *                                      
 *  02/21/2017  1.29.5  Vgott           References
 *                                      1. Enable the tooltip for chart mode options.
 *                                      2. Update the tooltip text format by removing '[' and ']' characters.
 *                                      
 *                                      Modifications
 *                                      1. Added tooltip text for all chart modes in Resource.resx file
 *                                      2. Added tooltip text from Resource.resx file for all chart mode ToolStripButtons.
 *                                      3. Update the tooltip text format for all tooltips in Resource.resx file.
 */
#endregion - [1.29] -
#region - [1.30] -
/*                                      
 * 
 *  02/25/2017  1.30.1   D.Smail        Modifications
 *                                      - Changed resource from SMCommunicationFaultReadTimeout from "Communication Fault - Read Timeout" to "Loss Of Communications"
 *                                      - If recording data and communications is lost, then save the existing information to the file and "kill" the recording information panel.
 *                                      - When communication is lost to the target hardware, disable all controls  except the "Home" button. This includes the ability to 
 *                                      select the Workset and  the Watch Variables.
 *                                      - When communication is lost to the target hardware, inform the Main Window of this event by making the Main Window's Communication Interface = null.
 *                                      - Upon exiting the Watch Form, inform the Main Window to resume polling the  target hardware.                                          
 *
 */
/*                                      
 * 
 *  06/23/2017  1.30.2   Vgott          References
 *                                      1.  Update the tooltip text for F5-Config and F3-Rec.
 *                                      2.  Added Tooltip text for  Up and Down buttons.
 *                                  
 *                                      Modifications
 *                                      1.  Update the tooltip text as "Open Data Monitoring Configuration window" instead "Configure Data Monitoring Window".
 *                                      2.  Update the tooltip text as "Record and save shown data" instead "Record Data Monitoring data".
 *                                      3.  Added Tooltip text as "Move the variable(s) up by 1 position" and "Move the variable(s) down by 1 position"
 *                                      
 *
 */
/*
 *  09/12/2017   1.30.3   Vgott         Modifications
...
[assembly: AssemblyVersion("1.30.3.0")]